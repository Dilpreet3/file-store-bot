...
ADMINS = int(environ.get("ADMINS", "5301311603"))
...
# Bot Information
BOT_TOKEN = environ.get("BOT_TOKEN", "7328827271:AAGTcwmezPUxUhcU8BhAG1wxEXg3sjbTOco")
BOT_USERNAME = environ.get("BOT_USERNAME", "Demon_slayerr_bot") # your bot username without @
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002197190084"))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002197190084')).split()]
...
class Var(object):
    ...
    if HAS_SSL:
        URL = "https://file-store-bot-stri.onrender.com"
    else:
        URL = "https://file-store-bot-stri.onrender.com"
